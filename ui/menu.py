...
class MainMenu:
    def __init__(self, screen, score_manager):
        ...
        self.current_state = "main"  # main, scores
        self.hovered_button = None
        self.hovered_scores = False
    ...
    def draw_main_menu(self):
        ...
        # Отрисовка частиц
        for particle in self.particles:
            color = (*self.accent_color[:2], particle['alpha'])
        ...
        for game in self.games:
            ...
            if scores:
                for i, score in enumerate(scores[:5]):  # Топ 5
                    ...
                    score_rect = score_surface.get_rect(center=(self.width // 2, y_offset + 40 + i * 25))
